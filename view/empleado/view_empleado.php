      ...
      <div class="modal-body">
        <div class="row">
            <div class="col-12 text-center mb-3">
                <img id="img_foto_editar" src="../plantilla/dist/img/avatar.png" class="emp-photo-preview mb-2" alt="Foto">
                <div>
                    <label class="btn btn-outline-primary btn-sm">
                        <i class="fas fa-camera"></i> Cambiar foto
                        <input type="file" id="txt_foto_editar" hidden accept="image/jpeg,image/png,image/webp" onchange="Preview_Foto_Empleado(this)">
                    </label>
                </div>
            </div>
            <div class="col-4">
