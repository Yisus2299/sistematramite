                        ...
                        <div class="row">
                            ...
                            <input type="text" class="form-control" id="txt_dni">
                                <div class="input-group-prepend">
                                    <button type="button" class="btn btn-success" onclick="Buscar_Remitente()" title="Buscar remitente en trámites anteriores"><i class="fa fa-search"></i></button>
                                </div>
                            <!-- /btn-group -->
                            ...
                            <div class="col-12 form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button type="button" class="btn btn-success" onclick="Verificar_Numero_Documento()" title="Verificar si el número ya existe"><i class="fa fa-search"></i></button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 form-group">
